		...
		<div class="row">
			<div class="col-xs-12">
				...
				<ul class="breadcrumb" itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
					...
					<li><strong itemprop="title">Tạo tài khoản</strong></li>
...
<div class="container">
	<h1 class="title-head"><a href="#">Tạo tài khoản</a></h1>
	<div class="row">
		<div class="col-lg-12 ">
			<div class="page-login">
				<div id="login">
					...
					<form accept-charset='UTF-8' action='https://dualeo-furniture.myharavan.com/account' id='create_customer' method='post'>
...
<input name='utf8' type='hidden' value='✓'>
					...
					<div class="form-signup clearfix">
						...
						<div class="col-xs-12 text-xs-left margin-bottom-30" style="margin-top:6px; padding: 0">
							...
							<a href="login.html" class="btn-link-style btn-register" style="margin-left: 20px;text-decoration: underline; ">Đăng nhập</a>
						</div>
					</div>

<input id='637b3b0cf54c4623b27851ac5bb3b035' name='g-recaptcha-response' type='hidden'><script src='../../www.google.com/recaptcha/api4d7a.js?render=6LdD18MUAAAAAHqKl3Avv8W-tREL6LangePxQLM-'></script><script>grecaptcha.ready(function() {grecaptcha.execute('6LdD18MUAAAAAHqKl3Avv8W-tREL6LangePxQLM-', {action: 'submit'}).then(function(token) {document.getElementById('637b3b0cf54c4623b27851ac5bb3b035').value = token;});});</script></form>
				</div>
			</div>
		</div>
	</div>
