                                    ...
                                    <li>
                                        <div class="dw-user-box p-3 d-flex">
                                            ...
                                            <div class="u-text ml-2">
                                                ...
                                                <a href="#" class="btn btn-rounded btn-danger btn-sm text-white d-inline-block">@lang('My Profile')</a>
                                            </div>
                                        </div>
                                    </li>
                                    <li role="separator" class="dropdown-divider"></li>
                                    <li class="user-list">
                                        <a class="px-3 py-2" href="#"><i class="ti-settings"></i> @lang('Change Password')</a>
                                    </li>
                                    <li role="separator" class="dropdown-divider"></li>
                                    <li class="user-list">
                ...
                <div class="user-profile position-relative">
                    ...
                    <div class="profile-text pt-1">
                        ...
                        <div class="dropdown-menu animated flipInY">
                            <a href="#" class="dropdown-item"><i class="ti-user"></i> @lang('My Profile')</a>
                            <div class="dropdown-divider"></div>
                            <a href="#" class="dropdown-item"><i class="ti-settings"></i> @lang('Change Password')</a>
                            <div class="dropdown-divider"></div>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <a class="sidebar-link waves-effect waves-dark" href="{{route('product.index')}}" aria-expanded="false">
                                <i class="ti-list-ol"></i><span class="hide-menu">Sản phẩm</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="{{route('category.index')}}" aria-expanded="false">
                                    <i class="ti-list-ol"></i><span class="hide-menu">Loại sản phẩm</span>
                                </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="{{route('group.index')}}" aria-expanded="false">
                                    <i class="ti-list-ol"></i><span class="hide-menu">Danh sách nhóm</span>
                                </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="{{route('product-group.index')}}" aria-expanded="false">
                                    <i class="ti-list-ol"></i><span class="hide-menu">Nhóm sản phẩm</span>
                                </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="{{route('brand.index')}}" aria-expanded="false">
                                    <i class="ti-list-ol"></i><span class="hide-menu">Thương hiệu</span>
                                </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="{{route('post.index')}}" aria-expanded="false">
                                    <i class="ti-list-ol"></i><span class="hide-menu">Bài đăng</span>
                                </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="{{route('tag.index')}}" aria-expanded="false">
                                    <i class="ti-list-ol"></i><span class="hide-menu">Thẻ Tag</span>
                                </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="{{route('post-tag.index')}}" aria-expanded="false">
                                    <i class="ti-list-ol"></i><span class="hide-menu">Thẻ bài đăng</span>
                                </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="{{route('order.index')}}" aria-expanded="false">
                                    <i class="ti-list-ol"></i><span class="hide-menu">Đơn đặt hàng</span>
                                </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="{{route('feedback.index')}}" aria-expanded="false">
                                    <i class="ti-list-ol"></i><span class="hide-menu">Phản hồi</span>
                                </a>
                        </li>
                        <li class="sidebar-item">
